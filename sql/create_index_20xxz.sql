use test;
drop table if exists `IDX_2021z`;
CREATE TABLE if not exists`IDX_2021z` (
...
) ENGINE=CONNECT DEFAULT CHARSET=latin1 `table_type`=CSV `file_name`='/var/mariadb/data/Index/2021/I*.zip'
