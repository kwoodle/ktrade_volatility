use test;
drop table if exists `USIDX_2021z`;
CREATE TABLE if not exists`USIDX_2021z` (
...
) ENGINE=CONNECT DEFAULT CHARSET=latin1 `table_type`=CSV `file_name`='/var/mariadb/data/Index/INDEX_2021.zip'
