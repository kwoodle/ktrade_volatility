-- May 30 2024
-- Cycle through individual years
-- Important to specify MyISAM for MERGE
-- use test;
use useq;
drop table if exists USEQ_2024;
create table if not exists USEQ_2024
(
