-- Must run in order of earlier to later insertions!
...
) ENGINE=CONNECT DEFAULT CHARSET=latin1 `table_type`=CSV `file_name`='/var/mariadb/data/USEQ/post_1111/USE_20211112.txt' `header`=0 `sep_char`=',';
